...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", env: {"EXTERNAL_IP" => EXTERNAL_IP}, inline: <<-SHELL
    ...
    cp /etc/rancher/k3s/k3s.yaml /home/vagrant/.kube/config_external
    cp /etc/rancher/k3s/k3s.yaml /home/vagrant/.kube/config
    chown vagrant:vagrant /home/vagrant/.kube/config_external
    sed -i "s/127\.0\.0\.1/${EXTERNAL_IP}/g" /home/vagrant/.kube/config_external
